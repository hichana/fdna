...
import NFTCatalog from "../../contracts/core/NFTCatalog.cdc"
import NFTRetrieval from "../../contracts/core/NFTRetrieval.cdc"

// note, usage of DND in frontend code reuires an 'id' member. For convenience here we make the 'id' use the NFT's UUID insetad of its actual ID
pub struct NFT {
    pub let id: UInt64
