...
transaction(
    ...
    prepare(signer: AuthAccount) {
        ...
        self.minter = signer.borrow<&Cats.NFTMinter>(from: Cats.MinterStoragePath)
    ...
    post {
        ...
        Cats.totalSupply == self.mintingIDBefore1 + 1: "The total supply should have been increased by 1"
    }
}
