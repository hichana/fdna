<div class="flex flex-col items-center">
	...
	<p class="text-md md:text-xl leading-6 md:leading-10 text-center mt-6 text-pink-300 max-w-2xl px-4 md:p-0">
		...
		duplicated, digital DNA to use across future experiences on Flow.
	</p>
</div>
