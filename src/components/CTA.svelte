...
<div class="inline-flex items-start justify-start p-2.5">
	...
	>
		<div
			class="flex flex-col space-y-16 items-center justify-end"
			style="width: 787px; height: 286px;"
		>
			<p class="text-6xl font-medium leading-10 text-center text-gray-800" style="width: 787px;">
				Digital DNA for Web3
			</p>
			<p class="text-xl leading-7 text-center text-gray-800" style="width: 440px;">
				NFTs are not just for collecting, they're building blocks to create new experiences on top
				of existing ones. With STRAND, the NFT assets in your wallet are used to create
				one-of-a-kind, never duplicated, digital DNA to use across future experiences on Flow.
			</p>
		</div>
